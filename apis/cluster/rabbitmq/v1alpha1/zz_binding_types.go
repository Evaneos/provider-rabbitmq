...
type BindingInitParameters struct {
	...
	// The source exchange.
	// +crossplane:generate:reference:type=github.com/evaneos/provider-rabbitmq/apis/cluster/rabbitmq/v1alpha1.Exchange
	// +crossplane:generate:reference:extractor=github.com/evaneos/provider-rabbitmq/config/cluster/common.ExtractResourceName()
