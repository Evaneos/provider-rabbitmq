...
import (
	...
	apisCluster "github.com/evaneos/provider-rabbitmq/apis/cluster"
	apisNamespaced "github.com/evaneos/provider-rabbitmq/apis/namespaced"
	"github.com/evaneos/provider-rabbitmq/config"
	"github.com/evaneos/provider-rabbitmq/internal/clients"
	controllerCluster "github.com/evaneos/provider-rabbitmq/internal/controller/cluster"
	controllerNamespaced "github.com/evaneos/provider-rabbitmq/internal/controller/namespaced"
	"github.com/evaneos/provider-rabbitmq/internal/features"
)
	...
	if *enableChangeLogs {
		...
		clo := xpcontroller.ChangeLogOptions{
			ChangeLogger: managed.NewGRPCChangeLogger(
				...
				managed.WithProviderVersion(fmt.Sprintf("provider:%s", "1.0"))),
		}
