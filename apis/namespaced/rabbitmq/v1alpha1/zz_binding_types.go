...
type BindingInitParameters struct {
	...
	// The source exchange.
	// +crossplane:generate:reference:type=github.com/evaneos/provider-rabbitmq/apis/namespaced/rabbitmq/v1alpha1.Exchange
	// +crossplane:generate:reference:extractor=github.com/evaneos/provider-rabbitmq/config/namespaced/common.ExtractResourceName()
