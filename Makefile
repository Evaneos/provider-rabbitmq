...
PROJECT_REPO ?= github.com/evaneos/$(PROJECT_NAME)
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-rabbitmq_v1.8.0
...
XPKG_REG_ORGS ?= xpkg.upbound.io/evaneos
...
#   You can check the basic implementation here: https://github.com/crossplane/uptest/blob/main/internal/rabbitmqs/03-delete.yaml.tmpl.
